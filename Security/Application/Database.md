...
- 후보키(Candidate Key): 키의 특성인 유일성과 최소성을 만족하는 키
...
- 키 무결성(key integrity): 한 릴레이션에 같은 키값을 가진 튜플(tuple)이 있어서는 안됨
- 개체 무결성(entity integrity): 기본키에 속해 있는 전체 또는 일부 속성은 널 값을 가질 수 없음
...
- SQL은 GRANT와 REVOKE라는 접근 권한 관리 명령어를 제공
